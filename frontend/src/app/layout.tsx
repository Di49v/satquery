  ...
  return (
    <html lang="en">
      <body className={`${inter.className} flex flex-col h-screen bg-slate-300 text-slate-800 antialiased overflow-hidden`}>
        ...
        {/* Main Header */}
        <header className="bg-gov-header text-white flex justify-between items-center px-4 py-2 shadow-lg z-50 shrink-0 border-b-4 border-gov-saffron relative">
          <div className="absolute bottom-[-8px] left-0 w-full h-1 bg-gov-green"></div>
          ...
          <div className="flex items-center space-x-6">
            ...
            <nav className="hidden md:flex space-x-2 text-xs font-medium items-center">
              ...
              <button className="hover:bg-slate-700 px-3 py-1.5 transition text-amber-400 font-bold border border-amber-600/30 bg-amber-900/20 ml-2 flex items-center">
